...
cwd = os.getcwd()
path = cwd+'/Permutation_test/'

path1 = path+data_name+"/"
...
pvalue_save = open(path1+'/'+data_name+'_'+asite+'_'+psite+'_'+esite+'.tab','w')

picklepath=cwd+'/Permutation_test/seperate_cooperativity_and_cooperativity_effect_pkl_file/'
tic=time.time()
