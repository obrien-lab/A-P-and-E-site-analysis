...
path= '/gpfs/group/epo2/default/nks5512/find_cooperativity_and_no_cooperativity/find_cooperativity_and_no_cooperativity_with_75%_coverage/'
...
#print(file_name)
PERMUTATION_LIST_file = open(path+file_name,'rb')
