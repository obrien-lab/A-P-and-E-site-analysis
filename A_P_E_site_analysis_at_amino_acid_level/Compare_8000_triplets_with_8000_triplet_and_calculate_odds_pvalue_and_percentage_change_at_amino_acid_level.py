...
Input_file_path_pickel = path+'A_site_profile_file/esite_asite_matrix_for_amino_acid/A-site_profiles_Pool_Translation_timesssAsite_psite_esite_times_coordinates.p'
